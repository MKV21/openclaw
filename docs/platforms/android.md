...
- Voice: Android uses a single mic on/off flow in the Voice tab with transcript capture and Android system TTS playback. Voice stops when the app leaves the foreground.
